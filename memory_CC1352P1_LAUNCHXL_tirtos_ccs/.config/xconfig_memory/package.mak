...
override PKGDIR = xconfig_memory
...
package/%.xdc.inc package/%_xconfig_memory.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_memory" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: memory.pem4f

-include package/cfg/memory_pem4f.mak
-include package/cfg/memory_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/memory_pem4f.dep
endif
memory.pem4f: package/cfg/memory_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
memory.pem4f package/cfg/memory_pem4f.c: .libraries,em4f
endif

package/cfg/memory_pem4f.c package/cfg/memory_pem4f.h package/cfg/memory_pem4f.xdl: override _PROG_NAME := memory.xem4f
package/cfg/memory_pem4f.c: package/cfg/memory_pem4f.cfg
package/cfg/memory_pem4f.xdc.inc: package/cfg/memory_pem4f.xdl
package/cfg/memory_pem4f.xdl package/cfg/memory_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/memory_pem4f.cfg
	-$(RM) package/cfg/memory_pem4f.dep
	-$(RM) package/cfg/memory_pem4f.c
	-$(RM) package/cfg/memory_pem4f.xdc.inc

clean,em4f::
	-$(RM) memory.pem4f
.executables,em4f .executables: memory.xem4f

memory.xem4f: |memory.pem4f

-include package/cfg/memory.xem4f.mak
memory.xem4f: package/cfg/memory_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/memory_pem4f.oem4f   package/cfg/memory_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
memory.xem4f: export C_DIR=
memory.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
memory.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

memory.test test,em4f test: memory.xem4f.test

memory.xem4f.test:: memory.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 memory.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.memory.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,memory.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
memory_pem4f.oem4f,copy : package/cfg/memory_pem4f.oem4f
memory_pem4f.sem4f,copy : package/cfg/memory_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_memory
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_memory.tar.dep
endif
package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml: package/build.cfg
package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_memory.tar: package/rel/xconfig_memory.xdc.inc package/rel/xconfig_memory/xconfig_memory/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_memory.xdc.inc,package/rel/xconfig_memory.tar.dep)


release release,xconfig_memory: all xconfig_memory.tar
clean:: .clean
	-$(RM) xconfig_memory.tar
	-$(RM) package/rel/xconfig_memory.xdc.inc
	-$(RM) package/rel/xconfig_memory.tar.dep
